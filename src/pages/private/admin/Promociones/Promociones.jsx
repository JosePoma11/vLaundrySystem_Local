...
import Cupon from '../../../../components/PRIVATE/OrdenServicio/Promocion/cupon';
...
const Promociones = () => {
  ...
  const handleSendMessage = () => {
    const number = phoneA;
    const mensaje = `¡Hola le saluda la *Lavanderia ${InfoNegocio.name}*, enviandole este *promocion* de *regalo* : *${promoSelected.descripcion}*, puede cangearlo con el siguiente codigo: *${promoSelected.codigoCupon}*`;
  ...
  useEffect(() => {
    if (formik.values.tipoPromocion === 'Varios') {
      if (!listPrendas.includes('Todos')) {
        setListPrendas(['Todos', ...listPrendas]);
      }
    }
  }, [formik.values.tipoPromocion, listPrendas]);
