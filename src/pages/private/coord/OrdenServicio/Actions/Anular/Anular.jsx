...
const Anular = ({ onReturn, onAnular }) => {
  ...
  const openModal = (values) =>
    modals.openConfirmModal({
      ...
      centered: true,
      children: <Text size="sm">¿ Estas seguro que quiere de ANULAR este pedido?</Text>,
      labels: { confirm: 'Si', cancel: 'No' },
      confirmProps: { color: 'red' },
      //onCancel: () => console.log("Cancel"),
      onConfirm: () => onAnular(values),
    });
        ...
        {({ handleSubmit, isSubmitting, errors, touched }) => (
          <Form onSubmit={handleSubmit} className="body-a">
            ...
            <div className="actions-bottom">
              ...
              <button type="button" className="btn-exm" onClick={() => onReturn('principal')}>
                Retroceder
              </button>
            </div>
          </Form>
