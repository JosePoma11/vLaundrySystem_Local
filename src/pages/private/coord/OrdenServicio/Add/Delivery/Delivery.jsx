...
import { AddOrdenServices_Delivery, ReserveOrdenServices } from '../../../../../../redux/actions/aOrdenServices';
...
const Delivery = () => {
  ...
  // Registrar
  const handleRegistrar = (infoRecibo) => {
    if (infoDelivery) {
      dispatch(
        AddOrdenServices_Delivery({
          infoRecibo,
          infoDelivery: { ...infoDelivery, name: infoRecibo.infoRecibo.Nombre },
        })
      ).then((res) => {
        if ('error' in res) {
          setRedirect(false);
